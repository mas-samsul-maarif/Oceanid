   ...
   <div class="row" style="margin-bottom: 50px; margin-top: 50px;">
       <div class="col-2 col-2"> 
        ...
        <div class="col-4 col-4">
            <a href="#" data-toggle="popover" data-trigger="focus" title="ㅤHiu" data-content="Ikan Hiu adalah sekelompok ikan dengan kerangka tulang rawan yang lengkap dan tubuh yang ramping. Mereka bernapas dengan menggunakan lima liang insang di samping, atau dimulai sedikit di belakang, kepalanya."> <img src="<?php echo base_url('img/Hiu.png'); ?>" width="150px" height="100px" alt="Hiu"></a><br><span><b>Hiu</b></span>
         </div>
        <div class="col-4 col-4"> 
             <a href="#" data-toggle="popover" data-trigger="focus" title="ㅤTeri" data-content="Ikan teri adalah sekelompok ikan laut kecil anggota suku Engraulidae. Nama ini mencakup berbagai ikan dengan warna tubuh perak kehijauan atau kebiruan. Walaupun anggota Engraulidae ada yang memiliki panjang maksimum 23 cm, nama ikan teri biasanya diberikan bagi ikan dengan panjang maksimum 5 cm."> <img src="<?php echo base_url('img/Teri.png'); ?>" width="150px" height="100px" alt="Teri"></a><br><span><b>Teri</b></span>
        </div>
        <div class="col-2 col-2"> 
...
<!-- Urutan ke 3-->
    <div class="row" style="margin-bottom: 50px; margin-top: 50px;">
        <div class="col-4 col-4"> 
            <a href="#" data-toggle="popover" data-trigger="focus" title="ㅤTuna" data-content="Tuna merupakan ikan laut pelagik yang termasuk bangsa Thunnini, terdiri dari beberapa spesies dari famili skombride, terutama genus Thunnus. Ikan ini adalah perenang andal. Tidak seperti kebanyakan ikan yang memiliki daging berwarna putih, daging tuna berwarna merah muda sampai merah tua."> <img src="<?php echo base_url('img/Tuna.png'); ?>" width="150px" height="100px" alt="Tuna"></a><br><span><b>Tuna</b></span>
        </div>
        <div class="col-4 col-4">
                <a href="#" data-toggle="popover" data-trigger="focus" title="ㅤTenggiri" data-content="Scomberomorini, umumnya disebut ikan tenggiri, adalah suku ikan bertulang pada keluarga makerel, Scombridae – yang masih memiliki kaitan dengan suku makerel, tuna dan bonito, ditambah Gasterochisma melampus. Suku ini terdiri dari 21 spesies dalam tiga genera: Acanthocybium A. solandri Grammatorcynus G. bicarinatus"> <img src="<?php echo base_url('img/Tenggiri.png'); ?>" width="150px" height="100px" alt="Tenggiri"></a><br><span><b>Tenggiri</b></span>
         </div>
        <div class="col-4 col-4"> 
              <a href="#" data-toggle="popover" data-trigger="focus" title="ㅤTongkol" data-content="Ikan tongkol berwarna agak gelap dan langsing, panjang ikan tongkol rata-rata sekitar 60 cm. Bagian punggung tongkol berwarna biru gelap metalik dengan pola garis-garis. Tongkol lebih banyak dikonsumsi masyarakat Jawa dan Sumatera."> <img src="<?php echo base_url('img/Tongkol.png'); ?>" width="150px" height="100px" alt="Tongkol"></a><br><span><b>Tongkol</b></span>
