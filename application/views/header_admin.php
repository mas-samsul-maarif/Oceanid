...
<body>
    <center><h1>OCEAN.ID ようこそ</h1></center>
    <div id="navbar" >
        ...
        <a class="b" href="<?php echo base_url()."index.php/hal_admin/admin"; ?>">Admin</a>
        <a class="b" href="<?php echo base_url()."index.php/hal_admin/pending"; ?>">Pending</a>
        <a class="b" href="<?php echo base_url()."index.php/hal_utama/main"; ?>">Log Out</a>
    </div>
</body>
</html>